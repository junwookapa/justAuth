...
public interface UserDao {
	...
	public User findbyObjectID(String _id); // 오브젝트 아이디에 의한 유저 검색
	public User findbyUserID(String user_id); // 유저 아이디에 의한 유저 검색
	public List<User> findAllUsers(); // 모든 유저 찾기
	public List<User> findAllUsersByUserGroupName(String userGroupName); // 유저 그룹에 의한 모든 유저 찾기
